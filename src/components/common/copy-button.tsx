...
export function CopyButton({
  ...
  return (
    <Button
      ...
      variant={variant}
      className={cn(
        'relative z-10 h-6 w-6 bg-muted/20 !text-white hover:bg-muted/5 dark:bg-muted/30 dark:hover:bg-muted/50 [&_svg]:size-3',
        className
      )}
      onClick={() => {
        if (proxyId) {
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          variant="ghost"
          className={cn(
            'hover:text-zinc-dark:50 relative z-10 h-6 w-6 bg-muted/20 !text-white hover:bg-muted/5 hover:bg-zinc-700 dark:bg-muted/30 dark:hover:bg-muted/50 [&_svg]:size-3',
            className
          )}
        >
          {hasCopied ? (
